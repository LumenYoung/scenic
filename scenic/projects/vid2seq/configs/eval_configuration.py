...
def get_config(runlocal=''):
  ...
  config.dataset_configs.base_dir = '/home/ec2-user/Documents/example_videos_tfrecords'
  config.dataset_configs.tables = {
      'validation': ['example_videos-00000-of-00002','example_videos-00001-of-00002'],
  }
